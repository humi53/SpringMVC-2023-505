...
<script type="text/javascript" src="${rootPath }/static/js/detail.js?20230717-001"></script>
</head>
<body>
	<p>${BBS.b_seq}
	<p>${BBS.b_date}
	...
	<c:if test="${empty BBS.b_image }">
		<img alt="" src="${rootPath }/static/no_image.png" width="200px"/>
	</c:if>
	<c:if test="${not empty BBS.b_image }">
		<img alt="" src="${rootPath }/files/${BBS.b_image}" width="200px"/>
	</c:if>
