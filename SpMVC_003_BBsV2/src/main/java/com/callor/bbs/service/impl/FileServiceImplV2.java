...
public class FileServiceImplV2 extends FileServiceImplV1{
	...
	public FileServiceImplV2(ResourceLoader resourceLoader, 
			String winPath, String windowsPath, String macHome, String macPath) {
		 ...
		 * final 로 선언된 2개의 변수(객체)를 초기화 해달라 요청
		 */
	}
