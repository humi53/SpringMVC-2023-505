...
<c:set value="20230704-002" var="version" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<script type="text/javascript" src="${rootPath }/static/js/main_nav.js?${version}"></script>
<script type="text/javascript" src="${rootPath }/static/js/input.js?${version}"></script>
<script type="text/javascript" src="${rootPath }/static/js/list.js?${version}"></script>
<script type="text/javascript" src="${rootPath }/static/js/detail.js?${version}"></script>
